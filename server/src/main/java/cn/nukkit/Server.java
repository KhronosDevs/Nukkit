    ...
    public Server(MainLogger logger, final String filePath, String dataPath, String pluginPath) {
        ...
        if (!new File(this.dataPath + "nukkit.yml").exists()) {
            ...
            InputStream advacedConf =
                    this.getClass().getClassLoader().getResourceAsStream("lang/" + language + "/nukkit.yml");
            if (advacedConf == null) {
        ...
        this.logger.info(getLanguage().translateString(
                "nukkit.server.start", TextFormat.AQUA + this.getVersion() + TextFormat.WHITE));
        ...
        this.logger.info(this.getLanguage().translateString(
                "nukkit.server.info", this.getName(),
